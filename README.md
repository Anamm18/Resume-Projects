...
**Included:** `sample_data.csv` — a synthetic 500-row e-commerce sales dataset (region, category, product, sales, profit, discount, ship mode) generated with realistic messiness: missing values in two columns, one extreme outlier order, and a duplicate row. Good for a quick first run.
